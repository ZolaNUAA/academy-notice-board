...
function buildPrompt(rawText) {
  ...
  const instruction = `从以下高校通知中提取结构化JSON。先列出关键要点，再输出JSON。
今天：${todayStr}
...
- 示例：["5月7日前提交申报材料","全校仅3个名额"]`;
  ...
  const example = {
    input: `【4.28-研究生-大中小教材项目】\n各位老师好，教育部大中小学课程教材研究项目申报开始进行，学校预计出校三项，申报时间较为紧张，预计5.7前要提交材料，若有意向申报老师可查看指南告知，提前准备申报书和相应附件材料，谢谢`,
    output: `先理解通知：这是关于教育部教材研究项目申报的通知，学校只有3个名额，5月7日前要提交材料。

解析结果：
[{"type":"研究生","title":"大中小教材项目","body":"各位老师好，教育部大中小学课程教材研究项目申报开始进行，学校预计出校三项，申报时间较为紧张，预计5.7前要提交材料，若有意向申报老师可查看指南告知，提前准备申报书和相应附件材料，谢谢","publishDate":"2026-04-28","deadline":"2026-05-07","importance":2,"owner":"未指定","location":null,"links":[],"keyPoints":["教育部教材研究项目开始申报","学校仅出校三项名额","5月7日前提交申报书和附件"]}]`
  };
